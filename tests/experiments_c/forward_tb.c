...
#define TB_FLAG_DROP  1   // bit0
#define TB_FLAG_ALLOW 2   // bit1
...
void NET_RECV__process_packet(buf_t packet) {
  ...
  // IPv4 total length does not include the Ethernet header; add 14 bytes for the Ethernet frame.
  ...
  meta.flags = drop * TB_FLAG_DROP + allow * TB_FLAG_ALLOW;
