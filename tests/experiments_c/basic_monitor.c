...
// Ethernet header (MAC split into 32+16 to avoid width mixing)
struct eth_header_t {
...
#define MON_FLAG_MAC_SWAPPED 2  // bit1
...
void NET_RECV__process_packet(buf_t packet) {
  ...
  outm.flags        = (BITS(32))MON_FLAG_MAC_SWAPPED;
